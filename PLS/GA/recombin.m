...
function NewChrom = recombin(REC_F, Chrom, RecOpt, SUBPOP, ObjV, FieldDR);
...
% Select individuals of one subpopulation and call low level function
   ...
   for irun = 1:SUBPOP,
      ...
      if nargin == 6,
         ...
         NewChromSub=feval(REC_F,ChromSub,RecOpt,ObjV,FieldDR);
         
      elseif nargin ==5,
         NewChromSub=feval(REC_F,ChromSub,RecOpt,ObjV);
      else 
